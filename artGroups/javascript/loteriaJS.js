const imageData = [
    ...
    description: "Modeled by my friend Angel, which I can say is anything but an angel. A little of a mischievous person, but a good friend who I know will make many people proud in life. I am very glad he was able to model for this card."},
    ...
    description: "Modeled by my friend Karina, which I am very grateful to be able to include in this project. She inspired me to look into the independent study option,and overall kinda jump started this project. Although we did not talk too much, I know she is a very kind, so so supportive, and talented person, and I am glad she was able to model for this card."},
    ...
    description: "Modeled by my best friend Zoey, it took a good bit of convincing to get her to do this, but I am happy she did. As such an important part of my college experience, I would've hated to not include her. She is a very interesting individual in the most complicated but best way possible. I am glad I met her and I am glad she did this card."},
    ...
    description: "Modeled by my friend Amadou, I am very glad he was down to be this card, as it is a little controversial, but I think it came out as one of the best cards in the collection. One of the first friends I made through Carleton, I am very happy to be able to include him in my project."},
    ...
    description: "Modeled by my friend Jose, which was honestly inspired by him learning to play the guitar the previous term. A fascinating person, always surprising me with the stuff he does, and lowkey started my path towards learning my alcohol limit, I am glad to be able to include him."}, 
    {src: "../images/loteria/chap3/Artboard 5.jpg",title: "El Mundo",
    description: "Modeled by my friend Sameer, I think this card came out amazing. He really did an amazing job for such an interesting card to have to model for. The first Carleton friend I met in person, I love him very much, I am very grateful to be able to include him in this project."}, 
    ...
    description: "Modeled by my friend Lizzet, I am very grateful that she was down to help me for this card. As mysterious and lowkey as she is, she is a very smart, hard-working, kind and supportive person which I am very glad to have met. I am so grateful to be able to include her in this project."}, 
